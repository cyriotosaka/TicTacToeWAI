...
import connectfour.HomeScreen;
import connectfour.SoundEffects;
...
//    public static final Color COLOR_BG = Color.WHITE;  // background
    ...
    public static final Color COLOR_GRID   = Color.DARK_GRAY;  // grid lines
    ...
    public TTTGraphics() {
        ...
        createMenuBar(); // Add the menu bar
    ...
    private void createMenuBar() {
        ...
        fileMenu.setForeground(new Color(0, 255, 255));

        JMenuItem newGameItem = new JMenuItem("New Game");
        newGameItem.setBackground(Color.BLACK);
        newGameItem.setForeground(new Color(0, 255, 255));
        ...
        JMenuItem exitItem = new JMenuItem("Exit to HomeScreen");
        exitItem.setBackground(Color.BLACK);
        exitItem.setForeground(new Color(0, 255, 255));
